    ...
    return (<div id="nvL">
     ...
     <Link to="/">  <img src={logo} height="50" alt="Unable to load the logo"></img></Link>
      ...
      <p className="exChange mr-3 pr-3 mb-0">EXCHANGE</p>
          ...
          <NavItem>
      <Link to="/login">  <Button className="lgBtn mr-3 p-2" outline={true} color="secondary" size="sm">LOG IN</Button></Link>
          </NavItem>
          <NavItem>
            <Link to="/signup"><Button className="lgBtn p-2" outline={true} color="secondary"size="sm">SIGN UP</Button></Link>
          </NavItem>
        </Nav>
      </div>
      </Navbar>
